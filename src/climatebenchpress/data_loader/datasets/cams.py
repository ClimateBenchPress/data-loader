...
if __name__ == "__main__":
    ...
    ds = open_downloaded_canonicalized_dataset(CamsNitrogenDioxideDataset, basepath=args.basepath)
    open_downloaded_tiny_canonicalized_dataset(CamsNitrogenDioxideDataset, basepath=args.basepath)
